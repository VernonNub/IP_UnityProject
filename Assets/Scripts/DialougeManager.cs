...
public class DialougeManager : MonoBehaviour
{
    ...
    private void ChangePlayerStats(List<float> stats)
    {
        if (speaker == "Nigel")
        {
            ai.happiness = GameManager.instance.NPC1Happiness;
            ai.relationship = GameManager.instance.NPC1Relationship;
        }
        else if (speaker == "Wei Jie")
        {
            ai.happiness = GameManager.instance.NPC2Happiness;
            ai.relationship = GameManager.instance.NPC2Relationship;
        }
        ...
        if(speaker == "Nigel")
        {
            GameManager.instance.NPC1Happiness = ai.happiness;
            GameManager.instance.NPC1Relationship = ai.relationship;
        }
        else if(speaker == "Wei Jie")
        {
            GameManager.instance.NPC2Happiness = ai.happiness;
            GameManager.instance.NPC2Relationship = ai.relationship;
        }
    }
